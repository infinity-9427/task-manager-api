...
export const getUserDashboard = async (req, res, next) => {
    try {
        ...
        // Get task statistics
        const [totalTasks, completedTasks, pendingTasks, inProgressTasks, overdueTasks, tasksByPriority, recentTasks, taskCompletionTrend] = await Promise.all([
...
export const getAdminDashboard = async (req, res, next) => {
    try {
        ...
        const [totalUsers, activeUsers, totalProjects, activeProjects, totalTasks, completedTasks, overdueTasks, userGrowth, tasksByStatus, tasksByPriority, projectsByStatus, topPerformers, systemActivity] = await Promise.all([
            // Total users
            prisma.user.count(),
...
export const getProjectAnalytics = async (req, res, next) => {
    try {
        ...
        const [totalTasks, tasksByStatus, tasksByPriority, teamMembers, timeTracking, taskCompletion] = await Promise.all([
